...
const Footer = () => {
  return (
    <footer className="w-full bg-gradient-to-b from-gray-50 to-gray-200 pt-8 sm:pt-12 pb-0 px-0 mt-8 sm:mt-10 border-t border-gray-200">
      <div className="w-full max-w-xs sm:max-w-2xl mx-auto flex flex-col items-center text-center gap-4 sm:gap-6">
        ...
        <form className="w-full flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 bg-gray-800 rounded-xl p-3 sm:p-4 shadow">
          ...
          <div className="flex flex-1 gap-2 w-full sm:w-auto">
            ...
            />
            <button type="submit" className="bg-pink-500 text-white px-4 sm:px-6 py-2 rounded-full font-bold hover:bg-pink-600 transition">SEND</button>
          </div>
        </form>
      </div>
      {/* Help Center Bar */}
